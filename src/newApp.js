    ...
    return (
      <div className='row widgets'>
        ...
        <Widget icon='circle-o-notch'
          color='orange'
          number={numeral(averageEdge).format('0.0') + '%'}
          description={`Average edge placed`}
        />
        <Widget icon='slack'
          color='red'
          number={ numeral(averageClosingEdge).format('0.0') + '%' }
...
export class App extends Component {
  ...
  fetchData() {
    ...
    request
      .post('http://localhost:4000/preset')
  ...
  onChangePreset(preset) {
    console.log('change preset called with', preset)
    this.setState({
      preset,
      modalOpen: false
    })
